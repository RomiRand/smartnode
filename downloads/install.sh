...
if [ "$PACKAGE_VERSION" = "latest" ]; then
    PACKAGE_URL="https://github.com/RomiRand/smartnode/raw/master/downloads/rp-smartnode-install-rpi4.tar.xz"
else
    PACKAGE_URL="https://github.com/RomiRand/smartnode/raw/master/downloads/rp-smartnode-install-rpi4.tar.xz"
fi
...
progress 8 "Installing arm64 rocketpool cli..."
{ mkdir -p $HOME/bin || fail "Could not create bin directory."; } >&2
{ wget -O $HOME/bin/rocketpool "https://github.com/RomiRand/smartnode/raw/master/downloads/rocketpool-cli-linux-arm64"; } >&2
{ chmod +x $HOME/bin/rocketpool; } >&2
